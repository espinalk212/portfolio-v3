...
const cards = ref([
  {
    ...
    title: 'My Hobbies',
    content:
      'During my free time you can find me studying, working out, or either watching or playing sports.' +
  ...
  },
  {
    ...
    title: 'My Journey',
    content:
      'I have always had a passion for technology but I never dreamed to pursue it until I started working at Equinox and' +
  ...
  },
  {
    ...
    content:
      "I believe that the best places to work are most often ones where it doesn't feel like work, I am looking for" +
  ...
  },
  {
    ...
    content:
      'I have been working since I was 13, I worked at Starbucks for almost 10 years and worked my way up to Assistant Store Manager, I later' +
    ...
    setTimeout(
      () =>
        alertStore.triggerNotification({
          ...
          description:
            "In the future when I publish blogs, badges like such will tell you there's a new one to read 😁"
        }),
      '2000'
    )
...
<template>
  ...
  <div v-else class="select-none c-info-card--container mt-20">
    <a-empty :description="null" />
    <a-card hoverable>
      <p class="text-lg font-bold text-center dark:text-black">
        Don't worry, you can restore the cards by either refreshing or pressing the
        <span
          class="shadow-cyan-500/50 border border-black bg-gradient-to-r from-cyan-700 to-teal-500 text-white font-semibold dark:bg-gradient-to-r dark:from-gray-200 dark:to-slate-500 dark:border dark:border-black dark:text-black rounded-lg p-2 m-1"
        >
          Restore Cards
        </span>
        button above 👆🏽
